...
#define FIFO_DEF(NAME) volatile unsigned char NAME ## _buf[64], NAME ## _head, NAME ## _tail;

#define FIFO_EXTERN(NAME) extern volatile unsigned char NAME ## _buf[64], NAME ## _head, NAME ## _tail;
